...
public class LevelController : MonoBehaviour
{
    ...
    public EnemyWaves[] enemyWaves;//Các kẻ thù có trong wave
    ...
    private void Start()
    {
        ...
        {
            StartCoroutine(CreateEnemyWave(enemyWaves[i].timeToStart, enemyWaves[i].wave));//Tạo các wave
        }
    ...
    /*IEnumerator PowerupBonusCreation()
    {
        while (true)
        {
            ...
            Instantiate(
                ...
                new Vector2(
                    Random.Range(PlayerController.instance.boundary.xMin, PlayerController.instance.boundary.xMax),
